    ...
    public class DataRun
    {
        ...
        public bool RunStep(Step steps, ProcHandle evt)
        {
            ...
            for (int i = evt.opsNum; i < steps.Ops.Count; i++)
            {
                ...
                if (steps.Ops[i].isStopPoint)
                {
                    ...
                    evt.m_evtTok.Set();
                    evt.isRun = 1;
                    SF.frmToolBar.btnPause?.Invoke(new Action(() => { SF.frmToolBar.btnPause.Text = "继续"; }));
                }
                ...
                try
                {
                    ...
                    if (evt.isAlarm)
                    {
                        ...
                        if (steps.Ops[i].AlarmType == "报警停止")
                            new Message($"发生报警:{evt.procNum}---{evt.stepNum}---{evt.opsNum}",
                                evt.alarmMsg == null ? "流程停止" : evt.alarmMsg, () => { evt.isThStop = true; }, "确定",
                                true);
                        //new Message($"发生报警:{0}---{0}---{1}", "流程停止", () => { }, "确定", true);
                        ...
                        {
                            evt.isGoto = true;
                            new Message($"发生报警:{evt.procNum}---{evt.stepNum}---{evt.opsNum}", alarmInfo.Note,
                                () => { ExecuteGoto(steps.Ops[i].Goto1, evt); },
                                !string.IsNullOrEmpty(alarmInfo.Btn1) ? alarmInfo.Btn1 : "确定", true);
                        }
                        ...
                        if (steps.Ops[i].AlarmType == "弹框确定与否")
                        {
                            ...
                            new Message($"发生报警:{evt.procNum}---{evt.stepNum}---{evt.opsNum}", alarmInfo.Note,
                                ...
                                !string.IsNullOrEmpty(alarmInfo.Btn1) ? alarmInfo.Btn1 : "确定",
                                !string.IsNullOrEmpty(alarmInfo.Btn2) ? alarmInfo.Btn2 : "否", true);
                        }
                        ...
                        if (steps.Ops[i].AlarmType == "弹框确定与否与取消")
                        {
                            ...
                            new Message($"发生报警:{evt.procNum}---{evt.stepNum}---{evt.opsNum}", alarmInfo.Note,
                                ...
                                !string.IsNullOrEmpty(alarmInfo.Btn1) ? alarmInfo.Btn1 : "确定",
                                !string.IsNullOrEmpty(alarmInfo.Btn2) ? alarmInfo.Btn2 : "否",
                                !string.IsNullOrEmpty(alarmInfo.Btn3) ? alarmInfo.Btn3 : "取消", true);
                        }
                    }
        ...
        public bool RunIoOperate(ProcHandle evt, IoOperate ioOperate)
        {
            ...
            foreach (IoOutParam ioParam in ioOperate.IoParams)
            {
                ...
                {
                    time = (int)SF.frmValue.dicValues[ioParam.delayBeforeV].GetDValue();
                }
                ...
                {
                    time = (int)SF.frmValue.dicValues[ioParam.delayAfterV].GetDValue();
                }
        ...
        public bool RunIoCheck(ProcHandle evt, IoCheck ioCheck)
        {
            ...
            {
                timeOut = (int)SF.frmValue.dicValues[ioCheck.timeOutC.TimeOutValue].GetDValue();
            }
        ...
        public bool RunProcOps(ProcHandle evt, ProcOps procOps)
        {
            ...
            foreach (procParam procParam in procOps.procParams)
            {
                ...
                {
                    proc = SF.frmProc.procsList.FirstOrDefault(sc =>
                        sc.head.Name.ToString() == SF.frmValue.dicValues[procParam.ProcValue].GetCValue());
                }
        ...
        public bool RunWaitProc(ProcHandle evt, WaitProc waitProc)
        {
            ...
            {
                timeOut = (int)SF.frmValue.dicValues[waitProc.timeOutC.TimeOutValue].GetDValue();
            }
            ...
            {
                DelayAfter = (int)SF.frmValue.dicValues[waitProc.delayAfterV].GetDValue();
            }
        ...
        public bool RunGoto(ProcHandle evt, Goto gotoParam)
        {
            if (gotoParam.Params != null)
            {
                ...
                if (!string.IsNullOrEmpty(gotoParam.ValueIndex))
                    value = SF.frmValue.dicValuesList[int.Parse(gotoParam.ValueIndex)].Value.ToString();
                else if (!string.IsNullOrEmpty(gotoParam.ValueIndex2Index))
                {
                    string index = SF.frmValue.dicValuesList[int.Parse(gotoParam.ValueIndex2Index)].Value.ToString();
                    value = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
                }
                else if (!string.IsNullOrEmpty(gotoParam.ValueName))
                {
                    value = SF.frmValue.dicValues[gotoParam.ValueName].Value.ToString();
                }
                else if (!string.IsNullOrEmpty(gotoParam.ValueName2Index))
                {
                    string index = SF.frmValue.dicValues[gotoParam.ValueName2Index].Value.ToString();
                    value = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
                }
                ...
                foreach (var item in gotoParam.Params)
                {
                    ...
                    {
                        itemValue = SF.frmValue.dicValuesList[int.Parse(item.MatchValueIndex)].Value.ToString();
                    }
                    else if (!string.IsNullOrEmpty(item.MatchValueV))
                    {
                        itemValue = SF.frmValue.dicValues[item.MatchValueV].Value.ToString();
                    }
            ...
            if (paramGoto.Params != null)
            {
                ...
                foreach (var item in paramGoto.Params)
                {
                    ...
                    if (!string.IsNullOrEmpty(item.ValueIndex))
                        value = SF.frmValue.dicValuesList[int.Parse(item.ValueIndex)].Value.ToString();
                    else if (!string.IsNullOrEmpty(item.ValueIndex2Index))
                    {
                        string index = SF.frmValue.dicValuesList[int.Parse(item.ValueIndex2Index)].Value.ToString();
                        value = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
                    }
                    else if (!string.IsNullOrEmpty(item.ValueName))
                    {
                        value = SF.frmValue.dicValues[item.ValueName].Value.ToString();
                    }
                    else if (!string.IsNullOrEmpty(item.ValueName2Index))
                    {
                        string index = SF.frmValue.dicValues[item.ValueName2Index].Value.ToString();
                        value = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
                    }
                    ...
                    else if (item.JudgeMode == "值在区间内")
                    {
                        if (item.equal)
                        {
                            tempValue = item.Down <= double.Parse(value) && double.Parse(value) <= item.Up
                                ? true
                                : false;
                        }
                        else
        ...
        public bool RunDelay(ProcHandle evt, Delay delay)
        {
            ...
            {
                time = int.Parse(SF.frmValue.dicValues[delay.timeMiniSecondV].Value);
            }
        ...
        public bool RunGetValue(ProcHandle evt, GetValue getValue)
        {
            foreach (var item in getValue.Params)
            {
                ...
                if (!string.IsNullOrEmpty(item.ValueSourceIndex))
                    value = SF.frmValue.dicValuesList[int.Parse(item.ValueSourceIndex)].Value.ToString();
                else if (!string.IsNullOrEmpty(item.ValueSourceIndex2Index))
                {
                    string index = SF.frmValue.dicValuesList[int.Parse(item.ValueSourceIndex2Index)].Value.ToString();
                    value = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
                }
                else if (!string.IsNullOrEmpty(item.ValueSourceName))
                {
                    value = SF.frmValue.dicValues[item.ValueSourceName].Value.ToString();
                }
                else if (!string.IsNullOrEmpty(item.ValueSourceName2Index))
                {
                    string index = SF.frmValue.dicValues[item.ValueSourceName2Index].Value.ToString();
                    value = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
                }
                ...
                {
                    string index = SF.frmValue.dicValuesList[int.Parse(item.ValueSaveIndex2Index)].Value.ToString();
                ...
                {
                    string index = SF.frmValue.dicValues[item.ValueSaveName2Index].Value.ToString();
                    SF.frmValue.setValueByIndex(int.Parse(index), value);
                }
            }
        ...
        public bool RunModifyValue(ProcHandle evt, ModifyValue ops)
        {
            ...
            if (!string.IsNullOrEmpty(ops.ValueSourceIndex))
                SourceValue = SF.frmValue.dicValuesList[int.Parse(ops.ValueSourceIndex)].Value.ToString();
            else if (!string.IsNullOrEmpty(ops.ValueSourceIndex2Index))
            {
                string index = SF.frmValue.dicValuesList[int.Parse(ops.ValueSourceIndex2Index)].Value.ToString();
                SourceValue = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
            }
            else if (!string.IsNullOrEmpty(ops.ValueSourceName))
            {
                SourceValue = SF.frmValue.dicValues[ops.ValueSourceName].Value.ToString();
            }
            else if (!string.IsNullOrEmpty(ops.ValueSourceName2Index))
            {
                string index = SF.frmValue.dicValues[ops.ValueSourceName2Index].Value.ToString();
                SourceValue = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
            }
            ...
            if (!string.IsNullOrEmpty(ops.ChangeValue))
            {
                ...
                ChangeValue = SF.frmValue.dicValuesList[int.Parse(ops.ChangeValueIndex)].Value.ToString();
            else if (!string.IsNullOrEmpty(ops.ChangeValueIndex2Index))
            {
                string index = SF.frmValue.dicValuesList[int.Parse(ops.ChangeValueIndex2Index)].Value.ToString();
                ChangeValue = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
            }
            else if (!string.IsNullOrEmpty(ops.ChangeValueName))
            {
                ChangeValue = SF.frmValue.dicValues[ops.ChangeValueName].Value.ToString();
            }
            else if (!string.IsNullOrEmpty(ops.ChangeValueName2Index))
            {
                string index = SF.frmValue.dicValues[ops.ChangeValueName2Index].Value.ToString();
                ChangeValue = SF.frmValue.dicValuesList[int.Parse(index)].Value.ToString();
            }
            ...
            {
                string index = SF.frmValue.dicValuesList[int.Parse(ops.OutputValueIndex2Index)].Value.ToString();
            ...
            {
                string index = SF.frmValue.dicValues[ops.OutputValueName2Index].Value.ToString();
                SF.frmValue.setValueByIndex(int.Parse(index), output);
            }
        ...
        public bool RunStringFormat(ProcHandle evt, StringFormat stringFormat)
        {
            ...
            foreach (var item in stringFormat.Params)
            {
                ...
                string SourceValue = "";
                if (!string.IsNullOrEmpty(item.ValueSourceIndex))
                    SourceValue = SF.frmValue.dicValuesList[int.Parse(item.ValueSourceIndex)].Value.ToString();
                else if (!string.IsNullOrEmpty(item.ValueSourceName))
                {
                    SourceValue = SF.frmValue.dicValues[item.ValueSourceName].Value.ToString();
                }
        ...
        public bool RunSplit(ProcHandle evt, Split split)
        {
            ...
            if (!string.IsNullOrEmpty(split.SourceValueIndex))
                SourceValue = SF.frmValue.dicValuesList[int.Parse(split.SourceValueIndex)].Value.ToString();
            else if (!string.IsNullOrEmpty(split.SourceValue))
            {
                SourceValue = SF.frmValue.dicValues[split.SourceValue].Value.ToString();
            }
            ...
            {
                SaveIndex = SF.frmValue.dicValues[split.Output].Index;
            }
        ...
        public bool RunReplace(ProcHandle evt, Replace replace)
        {
            ...
            if (!string.IsNullOrEmpty(replace.SourceValueIndex))
                SourceValue = SF.frmValue.dicValuesList[int.Parse(replace.SourceValueIndex)].Value.ToString();
            else if (!string.IsNullOrEmpty(replace.SourceValue))
            {
                SourceValue = SF.frmValue.dicValues[replace.SourceValue].Value.ToString();
            }
            ...
            if (!string.IsNullOrEmpty(replace.ReplaceStr))
            {
                ...
                replaceStr = SF.frmValue.dicValuesList[int.Parse(replace.ReplaceStrIndex)].Value.ToString();
            else if (!string.IsNullOrEmpty(replace.ReplaceStrV))
            {
                replaceStr = SF.frmValue.dicValues[replace.ReplaceStrV].Value.ToString();
            }
            ...
            if (!string.IsNullOrEmpty(replace.NewStr))
            {
                ...
                newStr = SF.frmValue.dicValuesList[int.Parse(replace.NewStrIndex)].Value.ToString();
            else if (!string.IsNullOrEmpty(replace.NewStrV))
            {
                newStr = SF.frmValue.dicValues[replace.NewStrV].Value.ToString();
            }
        ...
        public bool RunSetDataStructItem(ProcHandle evt, SetDataStructItem setDataStructItem)
        {
            ...
            {
                SF.frmdataStruct.Set_StructItem_byIndex(int.Parse(setDataStructItem.StructIndex),
                    int.Parse(setDataStructItem.ItemIndex), int.Parse(setDataStructItem.Params[i].valueIndex),
                    setDataStructItem.Params[i].value);
            }
        ...
        public bool RunGetDataStructItem(ProcHandle evt, GetDataStructItem getDataStructItem)
        {
            ...
            {
                int Startindex = SF.frmValue.dicValues[getDataStructItem.StartValue].Index;
                for (int i = 0;
                     i < SF.frmdataStruct.Get_StructItemCount_byIndex(int.Parse(getDataStructItem.StructIndex),
                         int.Parse(getDataStructItem.ItemIndex));
                     i++)
                {
                    object obj = SF.frmdataStruct.Get_StructItem_byIndex(int.Parse(getDataStructItem.StructIndex),
                        int.Parse(getDataStructItem.ItemIndex), i);

                    string value = "";
                    if (!string.IsNullOrEmpty(getDataStructItem.Params[i].ValueIndex))
                        value = SF.frmValue.dicValuesList[int.Parse(getDataStructItem.Params[i].ValueIndex)].Value
                            .ToString();
                    else
                        value = SF.frmValue.dicValues[getDataStructItem.Params[i].ValueName].Value.ToString();
            ...
            else
            {
                ...
                {
                    object obj = SF.frmdataStruct.Get_StructItem_byIndex(int.Parse(getDataStructItem.StructIndex),
                        int.Parse(getDataStructItem.ItemIndex), int.Parse(getDataStructItem.Params[i].valueIndex));
        ...
        public bool RunCopyDataStructItem(ProcHandle evt, CopyDataStructItem copyDataStructItem)
        {
            ...
            {
                DataStructItem ds = SF.frmdataStruct.dataStructs[int.Parse(copyDataStructItem.SourceStructIndex)]
                    .dataStructItems[int.Parse(copyDataStructItem.SourceItemIndex)];
                SF.frmdataStruct.dataStructs[int.Parse(copyDataStructItem.TargetStructIndex)]
                    .dataStructItems[int.Parse(copyDataStructItem.TargetItemIndex)] = ds;
            }
            else
            {
                for (int i = 0; i < copyDataStructItem.Params.Count; i++)
                {
                    object obj = SF.frmdataStruct.Get_StructItem_byIndex(
                        int.Parse(copyDataStructItem.SourceStructIndex), int.Parse(copyDataStructItem.SourceItemIndex),
                        int.Parse(copyDataStructItem.Params[i].SourcevalueIndex));

                    SF.frmdataStruct.Set_StructItem_byIndex(int.Parse(copyDataStructItem.TargetStructIndex),
                        int.Parse(copyDataStructItem.TargetItemIndex),
                        int.Parse(copyDataStructItem.Params[i].Targetvalue), obj.ToString());
                }
            }
        ...
        public bool RunInsertDataStructItem(ProcHandle evt, InsertDataStructItem insertDataStructItem)
        {
            ...
            SF.frmdataStruct.dataStructs[int.Parse(insertDataStructItem.TargetStructIndex)].dataStructItems
                .Insert(int.Parse(insertDataStructItem.TargetItemIndex), dataStructItem);
            for (int i = 0; i < insertDataStructItem.Params.Count; i++)
            {
                if (insertDataStructItem.Params[i].Type == "double")
                {
                    ...
                    SF.frmdataStruct.Set_StructItem_byIndex(int.Parse(insertDataStructItem.TargetStructIndex),
                        int.Parse(insertDataStructItem.TargetItemIndex), i, num.ToString());
                }
                else
                {
                    string str = "";
                    ...
                    SF.frmdataStruct.Set_StructItem_byIndex(int.Parse(insertDataStructItem.TargetStructIndex),
                        int.Parse(insertDataStructItem.TargetItemIndex), i, str);
                }
            }
        ...
        public bool RunDelDataStructItem(ProcHandle evt, DelDataStructItem delDataStructItem)
        {
            if (int.Parse(delDataStructItem.TargetStructIndex) >= 255)
                SF.frmdataStruct.dataStructs[int.Parse(delDataStructItem.TargetStructIndex)].dataStructItems.RemoveAt(
                    SF.frmdataStruct.dataStructs[int.Parse(delDataStructItem.TargetStructIndex)].dataStructItems.Count -
                    1);
            else if (int.Parse(delDataStructItem.TargetStructIndex) <= -1)
            {
                if (SF.frmdataStruct.dataStructs[int.Parse(delDataStructItem.TargetStructIndex)].dataStructItems
                        .Count != 0)
                    SF.frmdataStruct.dataStructs[int.Parse(delDataStructItem.TargetStructIndex)].dataStructItems
                        .RemoveAt(0);
            }
            else
            {
                SF.frmdataStruct.dataStructs[int.Parse(delDataStructItem.TargetStructIndex)].dataStructItems
                    .RemoveAt(int.Parse(delDataStructItem.TargetItemIndex));
            }
        ...
        public bool RunFindDataStructItem(ProcHandle evt, FindDataStructItem findDataStructItem)
        {
            ...
            {
                DataStructItem dst = SF.frmdataStruct.dataStructs[int.Parse(findDataStructItem.TargetStructIndex)]
                    .dataStructItems.FirstOrDefault(sc => sc.Name.ToString() == findDataStructItem.key);
                if (dst != null)
                    SF.frmValue.setValueByName(findDataStructItem.save, dst.Name);
            }
            else if (findDataStructItem.Type == "字符串等于key")
            {
                var matchingItems = SF.frmdataStruct.dataStructs[int.Parse(findDataStructItem.TargetStructIndex)]
                    .dataStructItems.Where(item => item.str.ContainsValue(findDataStructItem.key)).ToList();
            ...
            {
                var matchingItems = SF.frmdataStruct.dataStructs[int.Parse(findDataStructItem.TargetStructIndex)]
                    .dataStructItems.Where(item => item.num.ContainsValue(double.Parse(findDataStructItem.key)))
                    .ToList();
        ...
        public bool RunGetDataStructCount(ProcHandle evt, GetDataStructCount getDataStructCount)
        {
            ...
            SF.frmValue.setValueByName(getDataStructCount.ItemCount,
                SF.frmdataStruct.dataStructs[int.Parse(getDataStructCount.TargetStructIndex)].dataStructItems.Count);
        ...
        public bool RunTcpOps(ProcHandle evt, TcpOps tcpOps)
        {
            foreach (var op in tcpOps.Params)
            {
                ...
                {
                    Socketer socketClient =
                        SF.frmComunication.socketers.FirstOrDefault(sc => sc.SocketInfo.Name.ToString() == op.Name);
        ...
        public bool RunWaitTcp(ProcHandle evt, WaitTcp waitTcp)
        {
            foreach (var op in waitTcp.Params)
            {
                ...
                {
                    Socketer socketer =
                        SF.frmComunication.socketers.FirstOrDefault(sc => sc.SocketInfo.Name == op.Name);
                    if (socketer != null)
                    {
                        return true;
                    }
        ...
        public bool RunSendTcpMsg(ProcHandle evt, SendTcpMsg sendTcpMsg)
        {
            ...
            if (socketer != null)
            {
                ...
                SF.frmComunication.SendSocketMessage(socketer, SF.frmValue.get_Str_ValueByName(sendTcpMsg.Msg),
                    sendTcpMsg);
            }
        ...
        {
            Socketer socketer =
                SF.frmComunication.socketers.FirstOrDefault(sc => sc.SocketInfo.Name == receoveTcpMsg.ID);
            if (socketer != null)
            {
                socketer.Msg = null;
                socketer.isRun.Set();
                ...
                while (!evt.isThStop && Math.Abs(Environment.TickCount - start) < receoveTcpMsg.TImeOut)
                {
                    ...
                    {
                        if (int.TryParse(socketer.Msg, out int number))
                        {
        ...
        public bool RunSendSerialPortMsg(ProcHandle evt, SendSerialPortMsg sendSerialPortMsg)
        {
            SerialPorter serialPorter =
                SF.frmComunication.serialPorters.FirstOrDefault(sc => sc.serialPortInfo.Name == sendSerialPortMsg.ID);
            if (serialPorter != null)
            {
                serialPorter.isRun.Reset();
                SF.frmComunication.SendSerialPortMessage(serialPorter,
                    SF.frmValue.get_Str_ValueByName(sendSerialPortMsg.Msg), sendSerialPortMsg);
            }
        ...
        {
            SerialPorter serialPorter =
                SF.frmComunication.serialPorters.FirstOrDefault(sc =>
                    sc.serialPortInfo.Name == receoveSerialPortMsg.ID);
            if (serialPorter != null)
            {
        ...
        public bool RunSerialPortOps(ProcHandle evt, SerialPortOps serialPortOps)
        {
            foreach (var op in serialPortOps.Params)
            {
                SerialPortInfo serialPortInfo =
                    SF.frmComunication.serialPortInfos.FirstOrDefault(sc => sc.Name == op.Name);
                if (op.Ops == "启动")
                {
                ...
                else
                {
                    SerialPorter serialPorter =
                        SF.frmComunication.serialPorters.FirstOrDefault(sc =>
                            sc.serialPortInfo.Name.ToString() == op.Name);
        ...
        public bool RunWaitSerialPort(ProcHandle evt, WaitSerialPort waitSerialPort)
        {
            foreach (var op in waitSerialPort.Params)
            {
                ...
                {
                    SerialPorter serialPorter =
                        SF.frmComunication.serialPorters.FirstOrDefault(sc => sc.serialPortInfo.Name == op.Name);
                    if (serialPorter != null)
                    {
                        return true;
                    }
                        ...
                        while (evt.isThStop == false && station.GetState() == DataStation.Status.Run)
                        {
                            ...
                            for (int i = 0; i < 6; i++)
                            {
                                if (station.dataAxis.axisConfigs[i].AxisName == "-1")
                                    continue;
                                if (SF.frmCard.card.controlCards[int.Parse(station.dataAxis.axisConfigs[i].CardNum)]
                                        .axis[i].State == Axis.Status.Ready)
                                {
                                    isInPos = true;
                                }
                                else
            ...
            if (station != null)
            {
                ...
                if (posItems != null)
                {
                    ...
                    for (int i = 0; i < 6; i++)
                    {
                        ...
                        if (station.dataAxis.axisConfigs[i].AxisName != "-1")
                        {
                            ...
                            if (stationRunPos.ChangeVel == "改变速度")
                            {
                                ...
                                VelTemp = stationRunPos.Vel == 0
                                    ? SF.frmValue.dicValues[stationRunPos.VelV].GetDValue()
                                    : stationRunPos.Vel;
                                AccTemp = stationRunPos.Acc == 0
                                    ? SF.frmValue.dicValues[stationRunPos.AccV].GetDValue()
                                    : stationRunPos.Acc;
                                DecTemp = stationRunPos.Dec == 0
                                    ? SF.frmValue.dicValues[stationRunPos.DecV].GetDValue()
                                    : stationRunPos.Dec;
                            ...
                            {
                                Vel = SF.frmCard.card.controlCards[cardNum].axis[axisNum].SpeedMax *
                                      (SF.frmCard.card.controlCards[cardNum].axis[axisNum].SpeedRun / 100);
                                Acc = SF.frmCard.card.controlCards[cardNum].axis[axisNum].AccMax /
                                      (SF.frmCard.card.controlCards[cardNum].axis[axisNum].AccRun / 100);
                                Dec = SF.frmCard.card.controlCards[cardNum].axis[axisNum].DecMax /
                                      (SF.frmCard.card.controlCards[cardNum].axis[axisNum].DecRun / 100);
                            }

                            SF.motion.SetMovParam(cardNum, axisNum, 0, Vel, Acc, Dec, 0, 0,
                                SF.frmCard.card.controlCards[cardNum].axis[axisNum].PulseToMM);

                            SF.motion.Mov(ushort.Parse(station.dataAxis.axisConfigs[i].CardNum),
                                (ushort)station.dataAxis.axisConfigs[i].axis.AxisNum, Poses[i], 1, false);
                        }
                    }
                    ...
                    if (!stationRunPos.isUnWait)
                    {
                        ...
                        {
                            time = SF.frmValue.dicValues[stationRunPos.timeOutV].GetDValue();
                        }

                        while (evt.isThStop == false && cardNums.Count != 0 &&
                        ...
                        if (stationRunPos.isCheckInPos)
                        {
                            for (int i = 0; i < cardNums.Count; i++)
                            {
                                if (((SF.motion.GetAxisPos(cardNums[i], axisNums[i]) / SF.frmCard.card
                                        .controlCards[cardNums[i]].axis[axisNums[i]].PulseToMM - TargetPos[i])) > 0.01)
                                {
                                    evt.isAlarm = true;
                                    SF.frmInfo.PrintInfo($"工站：{stationRunPos.Name} {cardNums[i]}号卡{axisNums[i]}号轴运动未到位",
                                        FrmInfo.Level.Error);
                                }
                            }
                        }
        ...
        public bool RunStationRunRel(ProcHandle evt, StationRunRel stationRunRel)
        {
            ...
            if (station != null)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    if (station.dataAxis.axisConfigs[i].AxisName != "-1")
                    {
                        ...
                        if (stationRunRel.ChangeVel == "改变速度")
                        {
                            ...
                            VelTemp = stationRunRel.Vel == 0
                                ? SF.frmValue.dicValues[stationRunRel.VelV].GetDValue()
                                : stationRunRel.Vel;
                            AccTemp = stationRunRel.Acc == 0
                                ? SF.frmValue.dicValues[stationRunRel.AccV].GetDValue()
                                : stationRunRel.Acc;
                            DecTemp = stationRunRel.Dec == 0
                                ? SF.frmValue.dicValues[stationRunRel.DecV].GetDValue()
                                : stationRunRel.Dec;
                        ...
                        DistanceTemp = TargetPos[i] == 0
                            ? SF.frmValue.dicValues[TargetPosV[i]].GetDValue()
                            : TargetPos[i];

                        SF.motion.Mov(ushort.Parse(station.dataAxis.axisConfigs[i].CardNum),
                            (ushort)station.dataAxis.axisConfigs[i].axis.AxisNum, DistanceTemp, 0, false);
                    }
                }
                ...
                if (!stationRunRel.isUnWait)
                {
                    ...
                    {
                        time = SF.frmValue.dicValues[stationRunRel.timeOutV].GetDValue();
                    }
                    ...
                    if (stationRunRel.isCheckInPos)
                    {
                        for (int i = 0; i < cardNums.Count; i++)
                        {
                            if (((SF.motion.GetAxisPos(cardNums[i], axisNums[i]) /
                                  SF.frmCard.card.controlCards[cardNums[i]].axis[axisNums[i]].PulseToMM -
                                  TargetPos[i])) > 0.01)
                            {
                                evt.isAlarm = true;
                                SF.frmInfo.PrintInfo($"工站：{stationRunRel.Name} {cardNums[i]}号卡{axisNums[i]}号轴运动未到位",
                                    FrmInfo.Level.Error);
                            }
                        }
                    }
        ...
        public bool RunSetStationVel(ProcHandle evt, SetStationVel setStationVel)
        {
            ...
            if (station != null)
            {
                ...
                Vel = setStationVel.Vel == 0
                    ? SF.frmValue.dicValues[setStationVel.VelV].GetDValue()
                    : setStationVel.Vel;
                Acc = setStationVel.Acc == 0
                    ? SF.frmValue.dicValues[setStationVel.AccV].GetDValue()
                    : setStationVel.Acc;
                Dec = setStationVel.Dec == 0
                    ? SF.frmValue.dicValues[setStationVel.DecV].GetDValue()
                    : setStationVel.Dec;
                ...
                {
                    AxisConfig axisInfo =
                        station.dataAxis.axisConfigs.FirstOrDefault(sc => sc.AxisName == setStationVel.SetAxisObj);
        ...
        public bool RunWaitStationStop(ProcHandle evt, WaitStationStop waitStationStop)
        {
            ...
            if (station != null)
            {
                ...
                {
                    time = SF.frmValue.dicValues[waitStationStop.timeOutV].GetDValue();
                }
                ...
                while (evt.isThStop == false && station.GetState() == DataStation.Status.Run)
                {
                    ...
                    for (int i = 0; i < cardNums.Count; i++)
                    {
                        ...
                        {
                            if (SF.motion.HomeStatus(cardNums[i], axisNums[i]) &&
                                SF.frmCard.card.controlCards[cardNums[i]].axis[axisNums[i]].GetState() ==
                                Axis.Status.Ready)
                            {
                                isInPos = true;
                            }
